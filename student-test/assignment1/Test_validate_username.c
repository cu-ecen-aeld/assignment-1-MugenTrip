...
void test_validate_my_username()
{
     ...
     */
    const char * stored_name = my_username();
    char * query_name = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(stored_name, query_name,"AESD students, please fix me!");
}
